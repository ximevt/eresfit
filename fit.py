...
def user_input_features():
  ...
  height_cm = st.number_input('Altura en cm:', min_value=0, max_value=300, value = 0, step = 1)
  weight_cm = st.number_input('Peso en kg:', min_value=0, max_value=150, value = 0, step = 1)
  ...
  nutrition_quality = st.number_input('Calidad de nutrición (1 a 5):', min_value=1, max_value=5, value = 1, step = 1)
  activity_index = st.number_input('Nivel de actividad (1 a 10):', min_value=1, max_value=10, value =1, step = 1)

...
def user_input_features():
  ...
  ritmo cardiaco= st.number_input('Ritmo cardiaco:',min_value=0, max_value=200, value = 0, step = 1)
  presión = st.number_input('Presión arterial:', min_value=0, max_value=300, value = 0, step = 1)
  sueño = st.number_input('Horas de sueño:', min_value=0, max_value=24, value = 0, step = 1)
  nutrición = st.number_input('Calidad de nutrición (1 a 5):', min_value=1, max_value=5, value = 1, step = 1)
  ...
  género = st.number_input('Género (0: F) (1: M):', min_value=0, max_value=1, value = 0, step = 1)

  user_input_data = {'edad': age,
                     'altura': height_cm,
                     'peso': weight_kg,
                     'ritmo cardiaco': heart_rate,
